        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <br>
                ...
                <div class="container-fluid">
                  <form action="tambah.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="Name" required="" class="form-control" id="exampleInputPassword1" placeholder="Name">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Country Code</label>
                        <input type="text" name="CountryCode" required="" class="form-control" id="exampleInputPassword1" placeholder="Country Code">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">District</label>
                        <input type="text" name="District" required="" class="form-control" id="exampleInputPassword1" placeholder="District">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Population</label>
                        <input type="text" name="Population" required="" class="form-control" id="exampleInputPassword1" placeholder="Population">
                    </div>
                    <input type="submit" name="Submit" value="Tambahkan Baru" class="btn btn-primary"></input>
                  </form>
                ...
                $result = mysqli_query($mysqli, "INSERT INTO city(Name,CountryCode,District,Population) VALUES('$nama','$kode','$distrik','$populasi')");
                echo "Data Berhasil Ditambahkan. <a href='index.php'>Lihat Kota</a>";
                }
               ?>
